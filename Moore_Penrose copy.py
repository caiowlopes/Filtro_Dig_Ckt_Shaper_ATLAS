...
def f_LS1():
    ...
    rmse, _ = RMSE_e_MAE_por_ordem(sinal_estimado, sinal_original, True)
...
def f_LS2():
    ...
    rmse, _ = RMSE_e_MAE_por_ordem(sinal_estimado_2, sinal_original, True)
...
def f_LMS():
    melhor_ordem_lms = busca_ordem_otima_filtro(
        signal_original=sinal_original,
        ordem_mais_alta=21,
        filtro=filtro_LMS,
        readout=Readout_Shaper,
    ...
    RMSE = melhor_ordem_lms["RMSE"]
    MAE = melhor_ordem_lms["MAE"]
    ordem_f_rmse = melhor_ordem_lms["Ordem_Filtro_RMSE"]
    ordem_f_mae = melhor_ordem_lms["Ordem_Filtro_MAE"]
...
def f_NLMS():
    melhor_ordem_nlms = busca_ordem_otima_filtro(
        signal_original=sinal_original,
        ordem_mais_alta=21,
        filtro=filtro_NLMS,
        readout=Readout_Shaper,
    ...
    RMSE = melhor_ordem_nlms["RMSE"]
    MAE = melhor_ordem_nlms["MAE"]
    ordem_f_rmse = melhor_ordem_nlms["Ordem_Filtro_RMSE"]
    ordem_f_mae = melhor_ordem_nlms["Ordem_Filtro_MAE"]
    ...
    plot_estimado_x_original(
        ...
        original=sinal_original,
        limite_filtro=len(Readout_Shaper) - ordem_f_rmse + 1,
        title="Original x Estimado NLMS",
    )
